    ...
    >
      <div className="flex-1">
        <div className="flex items-center gap-4 mb-8">
          <span className="px-3 py-1 bg-brand/20 text-brand text-[10px] font-black uppercase tracking-widest">
            {project.type}
          </span>
          {project.highlight && (
        ...
        <p className="text-2xl font-medium text-white/60 mb-8">
          {project.tagline}
        </p>
        ...
        <div className="flex flex-wrap gap-2">
          {project.stack.map((s: string) => (
            <span
              key={s}
              className="px-3 py-1 border border-white/5 bg-white/5 text-[10px] font-bold uppercase tracking-widest text-white/40"
            >
              {s}
            </span>
          ))}

...
export default function Experience() {
  ...
  return (
    <section
      id="experience"
      className="py-32 px-4 md:px-12 bg-white text-black min-h-screen flex flex-col justify-center"
    >
      <div className="max-w-[1400px] w-full mx-auto">
        ...
        >
          <span className="text-xs font-black uppercase tracking-[0.4em] text-black/40 mb-4 block">
            Work Experience
          </span>
        ...
        <div className="flex flex-col md:flex-row h-[1200px] md:h-[700px] w-full gap-4">
                ...
                <div className="flex flex-col h-full">
                  ...
                  <p
                    className={cn(
                      ...
                      isHovered
                        ? "opacity-100"
                        : "opacity-80 md:opacity-0 md:hidden",
                    )}
                  >
                    {exp.description}
                  </p>
                  ...
                  <div
                    className={cn(
                      "flex-1 overflow-hidden transition-all duration-500 flex flex-col",
                  ...
                  >
                    <ul className="space-y-4">
                      {exp.bullets.map((b, j) => (
                        <li
                          key={j}
                          className="flex gap-3 items-start opacity-80 text-sm leading-relaxed"
                        >
                          <span
                            className={cn(
                  ...
                  <div className="mt-8 flex flex-wrap gap-2 pt-8 border-t border-black/5">
                    {exp.stack.map((s) => (
                      <span
                        key={s}
                        className="px-3 py-1 bg-black/5 text-[10px] font-bold uppercase tracking-widest rounded-full"
                      >
                        {s}
                      </span>
                    ))}

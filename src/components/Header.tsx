  ...
  return (
    <motion.header
      ...
      className={cn(
        ...
        isLight ? "bg-white/70 border border-black/10 text-black shadow-sm" : "bg-black/50 border border-white/10 text-white"
      )}
    >
      ...
      <div className="pointer-events-auto">
        <button className={cn(
          ...
          isLight ? "border-black/20 hover:border-black" : "border-white/20 hover:border-white"
        )}>
          REQUIRE
        </button>
      </div>
